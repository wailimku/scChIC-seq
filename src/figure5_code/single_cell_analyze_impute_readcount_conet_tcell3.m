...
%a=readtable('/data/kuw/biocore/wlku/Keji/human_T_H3K27me3/bulk_H3K27me3_T_rc_52798_mat.txt');
%H3K27me3_rc = table2array(a(:,2));
%H3K27me3_cpm = log2(H3K27me3_rc*1000000/sum(H3K27me3_rc)+1);
%H3K4me3_cpm = wbc_cpm_type(:,4);
...
[ia,ib,ic] = intersect(cd4_atac_gene,Th_gene);
scrna_mat = Th_exp(ic,:);
scatac_mat = cd4_atac_exp(ib,:);
cd4_atac_peak2 = cd4_atac_peak(ib);

[ia2,ib2,ic2] = intersect(ia, peakgene2,'stable');
scchip_mat = log2(cpm33(ic2,:)+1);
scrna_mat = scrna_mat(ib2,:);
scatac_mat =scatac_mat(ib2,:);
cd4_atac_peak3 = cd4_atac_peak2(ib2);
...
q = find(xx2(:,sel6)./xx2(:,sel5)<cuto1 & xx2(:,sel5)./xx2(:,sel6)<cuto1 & xx2(:,sel1)./xx2(:,sel2)<cuto1 & xx2(:,sel2)./xx2(:,sel1)<cuto1 & xx2(:,sel3)./xx2(:,sel4)>cuto2);
%biva1 = [H3K27me3_cpm3(q),H3K4me3_cpm3(q)];
peakname4 = peakname3(q);
%writetable(table(peakname4),'/data/kuw/biocore/wlku/Keji/wbc_285_read1_mapped/conet_het_result/conet_het_scrna_sch3k4_rhigh_het_clow_het2_tcell.txt');
...
writetable(table(peakname4),'../../data/output/Figure5/conet_het_result/conet_het_scrna_sch3k4_rhigh_het_clow_het2_tcell.txt');

%q = find(xx2(:,sel6)./xx2(:,sel5)<2 & xx2(:,sel5)./xx2(:,sel6)<2 & xx2(:,sel1)./xx2(:,sel2)<2 & xx2(:,sel2)./xx2(:,sel1)<2 & xx2(:,sel4)./xx2(:,sel3)>1.5);
q = find(xx2(:,sel6)./xx2(:,sel5)<cuto1 & xx2(:,sel5)./xx2(:,sel6)<cuto1 & xx2(:,sel1)./xx2(:,sel2)<cuto1 & xx2(:,sel2)./xx2(:,sel1)<cuto1 & xx2(:,sel4)./xx2(:,sel3)>cuto2);
%biva2 = [H3K27me3_cpm3(q),H3K4me3_cpm3(q)];
peakname4 = peakname3(q);
%writetable(table(peakname4),'/data/kuw/biocore/wlku/Keji/wbc_285_read1_mapped/conet_het_result/conet_het_scrna_sch3k4_rhigh_het_chigh_het2_tcell.txt');
...
writetable(table(peakname4),'../../data/output/Figure5/conet_het_result/conet_het_scrna_sch3k4_rhigh_het_chigh_het2_tcell.txt');
