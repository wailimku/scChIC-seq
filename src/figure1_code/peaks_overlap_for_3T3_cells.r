...
chicpeaks <- getPeaks('./data/output/Figure1/KZ1252_GB0640_0_0_mapq10_noDup-W200-G200-E500.scoreisland',sort_peaks = TRUE)



chicpeaks3000 <- getPeaks('./data/output/Figure1/KZ1225_GB0451_0_0_mapq10_noDup-W200-G200-E100.scoreisland',sort_peaks = TRUE)
chicpeaks1000 <- getPeaks('./data/output/Figure1/KZ1245-2_0_0_mapq10_noDup-W200-G200.scoreisland',sort_peaks = TRUE)
chicpeaks300 <- getPeaks('./data/output/Figure1/KZ1245-3_0_0_mapq10_noDup-W200-G200.scoreisland',sort_peaks = TRUE)
chicpeaks100 <- getPeaks('./data/output/Figure1/KZ1245-4_0_0_mapq10_noDup-W200-G200.scoreisland',sort_peaks = TRUE)
...
if(kkk==2)
{
	pdf("./data/Figures/Figure1/barplot_precision_3T3_low_cell_num.pdf")
...
if(kkk==3)
{
	pdf("./data/Figures/Figure1/barplot_senstivity_3T3_low_cell_num.pdf")
