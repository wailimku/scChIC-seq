...
if(kkk==1)
{
	aa2<-read.table(paste0("./data/",folder1,"/Figure1/scChIC_3000a_3T3_readcount_at_3T3_peak.txt"))
}  
if(kkk==2)
{
	aa2<-read.table(paste0("./data/",folder1,"/Figure1/scChIC_3000b_3T3_readcount_at_3T3_peak.txt"))

} 
if(kkk==3)
{
	aa2<-read.table(paste0("./data/",folder1,"/Figure1/scChIC_1000b_readcount_at_3T3_peak.txt"))

} 
if(kkk==4)
{
	aa2<-read.table(paste0("./data/",folder1,"/Figure1/scChIC_300b_3T3_readcount_at_3T3_peak.txt"))
